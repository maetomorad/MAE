...
<p>X-ray computed tomography, the production of three-dimensional tomographic volumes and two-dimensional tomograms, provides MAE researchers with the ability to non-distructively section and examine ceramic artifacts with resolutions as fine as dozens on microns. A computed combination of radiogarphs, XCT can most easily be described as the a "moving" radiograph, in the same way that motkon pictures are simply a moving sequence of individual photographs. While radiography takes a single two-dimensional image of each sample, data acquisition for XCT involves collecting many radiographs of the sample taken from unique angles as the sample stage rotates 360 degress. Following data acqusition, these radiographs are <b>computed</b> into a three-dimensional volume through a process called "back projection" and made available for a variety of qualitative and quantitative manipulations, including slicing, porosity estimation, void mapping, etc.</p>
<p>XCT data collection at ANL is conducted with both linear (CMOS) and area detectors, utilizing custom data acqusition softwares, which MAE has augmented for the particular vicissitudes of archaeological materials analysis. sWorking in concert with ANL scientists, MAE researchers now back project XCT data on the Sun Solaris computing platform at the University of Chicago's Department of Anthropology's. As a multi-threaded application running on a 64-processor server, back projection and post-processing is now quick and agile.</p>
<p><a href="instrumentation.php">back to top</a></p>
<div class="hr_thin"></div>
